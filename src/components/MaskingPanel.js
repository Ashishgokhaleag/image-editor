...
const MaskingPanel = ({ canvas, activeImage }) => {
      ...
      fabric.Image.fromURL(e.target.result, (maskImg) => {
        ...
        if (maskImg.width > maxWidth || maskImg.height > maxHeight) {
          const scale = Math.min(
            maxWidth / maskImg.width,
            maxHeight / maskImg.height
          );
          maskImg.scale(scale);
        }
  ...
  return (
    <div className="p-6 bg-gradient-to-r from-gray-800 via-gray-700 to-gray-600 rounded-xl shadow-lg text-white max-w-sm mx-auto mb-2">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <label className="relative group cursor-pointer">
            <input
              ...
              className="hidden"
            />
            <div className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-blue-500 rounded-lg hover:bg-blue-500/10 transition-all bg-blue-500/5">
              <Image
                size={28}
                className="mb-2 text-blue-500 group-hover:text-white"
              />
          ...
          <button
            ...
            className="flex flex-col items-center justify-center p-6 border-2 border-red-500 rounded-lg hover:bg-red-500/10 transition-all bg-red-500/5"
          >
            <X size={28} className="mb-2 text-red-500" />
